...
var Cufon = (function () {
  ...
  var DOM = (api.DOM = {
    ready: (function () {
      ...
      if (!fabric.window.opera && fabric.document.readyState)
        (function () {
          readyStatus[fabric.document.readyState]
            ? perform()
  ...
  var CSS = (api.CSS = {
    ...
    ready: (function () {
      ...
      var styleElements = Object.prototype.propertyIsEnumerable
      ...
      DOM.ready(function () {
        ...
        if (
          fabric.document.styleSheets.length >=
          styleElements.length + linkStyles
        )
          perform();
...
Cufon.registerEngine(
  ...
  (function () {
    ...
    var HAS_BROKEN_LINEHEIGHT =
      !HAS_INLINE_BLOCK &&
      (fabric.document.compatMode == "BackCompat" ||
    ...
    return function (font, text, style, options, node, el) {
      ...
      letterSpacing =
        letterSpacing == "normal"
          ? 0
          : size.convertFrom(parseInt(letterSpacing, 10));
      ...
      canvas.width = Math.ceil(
        size.convert(width + expandRight - expandLeft) * roundingFactor
      );
      ...
      var totalLineHeight =
        (options.lineHeight - 1) * size.convert(-font.ascent / 5) * (lines - 1);
      ...
      for (
        var offsets = Cufon.textOptions.shadowOffsets, i = shadowOffsets.length;
        i--;
      ...
      g.translate(
        ...
        -expandLeft -
          ((1 / scale) * canvas.width) / 2 +
          (Cufon.fonts[font.family].offsetLeft || 0),
        -expandTop -
          Cufon.textOptions.height / scale / 2 +
          (Cufon.fonts[font.family].offsetTop || 0)
      );
      ...
      function renderBackground() {
        ...
        for (var i = 0, l = chars.length; i < l; ++i) {
          if (chars[i] === "\n") {
            ...
            var topOffset =
              -font.ascent - (font.ascent / 5) * options.lineHeight;
          ...
          if (i == l - 1) {
            ...
            boundaries[boundaries.length - 1].height =
    ...
    return function (font, text, style, options, node, el, hasNext) {
      ...
      if (letterSpacing == undefined) {
        ...
        style.computedLSpacing = letterSpacing =
          letterSpacing == "normal"
            ? 0
            : ~~size.convertFrom(getSizeInPixels(el, letterSpacing));
      }
      ...
      wStyle.width = Math.max(
        Math.ceil(size.convert(width * roundingFactor)),
        0
      );
...
(function () {
  ...
  function enlivenObjects(objects, callback) {
    function getKlass(type) {
      return fabric[
        fabric.util.string.camelize(fabric.util.string.capitalize(type))
      ];
    }
...
(function (global) {
  ...
  function pointerX(event) {
    ...
    return (
      event.pageX ||
      (typeof event.clientX != "unknown" ? event.clientX : 0) +
  ...
  function pointerY(event) {
    ...
    return (
      event.pageY ||
      (typeof event.clientY != "unknown" ? event.clientY : 0) +
      ...
      if (typeof style == "string") {
        style = style
          ...
          .forEach(function (current) {
            ...
            oStyle[normalizeAttr(attr[0].trim().toLowerCase())] =
              attr[1].trim();
          });
      } else {
...
(function () {
  ...
  fabric.Gradient = fabric.util.createClass(
    /** @scope fabric.Gradient.prototype */ {
  ...
  fabric.util.object.extend(fabric.Gradient, {
    ...
    fromElement: function (el, instance) {
      ...
      for (var i = colorStopEls.length; i--; ) {
        ...
        colorStops[offset] =
          getColorStopFromStyle(el) || el.getAttribute("stop-color");
      }
...
(function (global) {
  ...
  extend(
    ...
    /** @scope fabric.StaticCanvas.prototype */ {
      /**
      ...
      _initCanvasElement: function (element) {
        if (
          typeof element.getContext === "undefined" &&
      ...
      bringForward: function (object) {
        ...
        if (idx !== objects.length - 1) {
          ...
          for (var i = idx + 1, l = this._objects.length; i < l; ++i) {
            if (
              object.intersectsWithObject(objects[i]) ||
              object.isContainedWithinObject(this._objects[i])
            ) {
              nextIntersectingIdx = i;
              break;
  ...
  var InteractiveMethods = /** @scope fabric.Canvas.prototype */ {
    ...
    __onMouseDown: function (e) {
      ...
      if (this._shouldClearSelection(e)) {
        ...
        var shouldHandleGroupLogic =
          e.shiftKey &&
          (activeGroup || this.getActiveObject()) &&
          this.selection;
    ...
    _finalizeDrawingPath: function () {
      ...
      this.add(p);
      p.set("left", minX + (maxX - minX) / 2)
        .set("top", minY + (maxY - minY) / 2)
        .setCoords();
      this.renderAll();
    ...
    _scaleObject: function (x, y, by) {
      ...
      var lastLen = sqrt(
          pow(t.ey - t.top - offset.top, 2) +
            pow(t.ex - t.left - offset.left, 2)
        ),
        curLen = sqrt(
          pow(y - t.top - offset.top, 2) + pow(x - t.left - offset.left, 2)
        );
    ...
    findTarget: function (e, skipGroup) {
      ...
      for (var i = 0, len = possibleTargets.length; i < len; i++) {
        var pointer = this.getPointer(e);
        var isTransparent = this._isTargetTransparent(
          possibleTargets[i],
          pointer.x,
          pointer.y
        );
    ...
    try {
      objects.forEach(function (obj, index) {
        ...
        if (typeof path !== "string") {
          switch (obj.type) {
            case "image":
              fabric[fabric.util.string.capitalize(obj.type)].fromObject(
                obj,
                function (o) {
            ...
            default:
              var klass =
                fabric[
                  fabric.util.string.camelize(
                    fabric.util.string.capitalize(obj.type)
                  )
                ];
          ...
          if (obj.type === "image") {
            ...
            if (obj.useNative) {
              ...
              var onscriptload = function () {
                ...
                if (
                  Object.prototype.toString.call(fabric.window.opera) ===
                  "[object Opera]"
                ) {
                  setTimeout(function () {
    ...
    /** @scope fabric.Object.prototype */ {
      ...
      getSvgStyles: function () {
        return [
          ...
          "; ",
          "stroke-dasharray: ",
          this.strokeDashArray ? this.strokeDashArray.join(" ") : "; ",
          "fill: ",
      ...
      getSvgTransform: function () {
        ...
        return [
          ...
          this.scaleX === 1 && this.scaleY === 1
            ? ""
            : " scale(" +
              toFixed(this.scaleX, 2) +
              " " +
              toFixed(this.scaleY, 2) +
              ")",
        ].join("");
      },
      ...
      setCoords: function () {
        ...
        this.currentWidth =
          (this.width + strokeWidth) * this.scaleX + padding * 2;
        this.currentHeight =
      ...
      drawBorders: function (ctx) {
        ...
        var scaleX =
            1 / (this.scaleX < MIN_SCALE_LIMIT ? MIN_SCALE_LIMIT : this.scaleX),
          scaleY =
            1 / (this.scaleY < MIN_SCALE_LIMIT ? MIN_SCALE_LIMIT : this.scaleY);
      ...
      _renderDashedStroke: function (ctx) {
        ...
        function renderSide(xMultiplier, yMultiplier) {
          var lineLength = 0,
            sideLength =
              (yMultiplier ? _this.height : _this.width) + padding * 2;
          ...
          while (lineLength < sideLength) {
            ...
            if (xMultiplier) {
              x +=
                lengthOfSubPath * xMultiplier - (lengthDiff * xMultiplier || 0);
            } else {
              y +=
                lengthOfSubPath * yMultiplier - (lengthDiff * yMultiplier || 0);
            }
      ...
      toGrayscale: function () {
        ...
        if (fillValue) {
          this.set(
            "overlayFill",
            new fabric.Color(fillValue).toGrayscale().toRgb()
          );
        }
        return this;
      },
...
(function (global) {
  ...
  fabric.Line = fabric.util.createClass(
    ...
    /** @scope fabric.Line.prototype */ {
      ...
      _setWidthHeight: function (options) {
        ...
        this.set(
          "left",
          "left" in options ? options.left : this.x1 + this.width / 2
        );
        this.set(
          "top",
          "top" in options ? options.top : this.y1 + this.height / 2
        );
      },
      ...
      _render: function (ctx) {
        ...
        ctx.moveTo(
          this.width === 1 ? 0 : -this.width / 2,
          this.height === 1 ? 0 : -this.height / 2
        );
        ctx.lineTo(
          this.width === 1 ? 0 : this.width / 2,
          this.height === 1 ? 0 : this.height / 2
  ...
  fabric.Line.ATTRIBUTE_NAMES =
    "x1 y1 x2 y2 stroke stroke-width transform".split(" ");
...
(function (global) {
  ...
  fabric.Circle.ATTRIBUTE_NAMES =
    "cx cy r fill fill-opacity opacity stroke stroke-width transform".split(
      " "
    );
...
(function (global) {
  ...
  fabric.Triangle = fabric.util.createClass(
    fabric.Object,
    /** @scope fabric.Triangle.prototype */ {
      /**
       * @property
       * @type String
       */
...
(function (global) {
  ...
  fabric.Ellipse = fabric.util.createClass(
    fabric.Object,
    /** @scope fabric.Ellipse.prototype */ {
      /**
       * @property
       * @type String
       */
  ...
  fabric.Ellipse.ATTRIBUTE_NAMES =
    "cx cy rx ry fill fill-opacity opacity stroke stroke-width transform".split(
      " "
    );
...
(function (global) {
  ...
  fabric.Rect.ATTRIBUTE_NAMES =
    "x y width height rx ry fill fill-opacity opacity stroke stroke-width transform".split(
      " "
    );
...
(function (global) {
  ...
  fabric.Polyline = fabric.util.createClass(
    fabric.Object,
    /** @scope fabric.Polyline.prototype */ {
      /**
       * @property
       * @type String
       */
  ...
  fabric.Polyline.ATTRIBUTE_NAMES =
    "fill fill-opacity opacity stroke stroke-width transform".split(" ");
...
(function (global) {
  ...
  fabric.Polygon = fabric.util.createClass(
    fabric.Object,
    /** @scope fabric.Polygon.prototype */ {
      /**
       * @property
       * @type String
       */
...
(function (global) {
      ...
      _parsePath: function () {
        ...
        for (var i = 0, j, chunksParsed, len = this.path.length; i < len; i++) {
          ...
          if (chunksParsed.length - 1 > commandLength) {
            for (
              var k = 1, klen = chunksParsed.length;
              k < klen;
              k += commandLength
            ) {
              result.push(
                [chunksParsed[0]].concat(
                  chunksParsed.slice(k, k + commandLength)
                )
              );
            }
          } else {
  ...
  fabric.Path.ATTRIBUTE_NAMES =
    "d fill fill-opacity opacity fill-rule stroke stroke-width transform".split(
      " "
    );
...
(function (global) {
  ...
  fabric.PathGroup = fabric.util.createClass(
    fabric.Path,
    /** @scope fabric.PathGroup.prototype */ {
      /**
       * @property
       * @type String
       */
  ...
  fabric.Group = fabric.util.createClass(
    ...
    /** @scope fabric.Group.prototype */ {
      ...
      render: function (ctx, noTransform) {
        ...
        for (
          var i = 0, len = this.objects.length, object;
      ...
      complexity: function () {
        return this.getObjects().reduce(function (total, object) {
          total +=
            typeof object.complexity == "function" ? object.complexity() : 0;
          return total;
        }, 0);
      },
...
(function (global) {
      ...
      _initFilters: function (object) {
        if (object.filters && object.filters.length) {
          this.filters = object.filters.map(function (filterObj) {
            return (
              filterObj &&
              fabric.Image.filters[filterObj.type].fromObject(filterObj)
            );
          });
        }
      },
  ...
  fabric.Image.ATTRIBUTE_NAMES =
    "x y width height fill fill-opacity opacity stroke stroke-width transform xlink:href".split(
      " "
    );
...
fabric.Image.filters.Grayscale = fabric.util.createClass(
  /** @scope fabric.Image.filters.Grayscale.prototype */ {
    /**
     * @param {String} type
     */
    type: "Grayscale",
...
fabric.Image.filters.RemoveWhite = fabric.util.createClass(
  /** @scope fabric.Image.filters.RemoveWhite.prototype */ {
    /**
     * @param {String} type
     */
    type: "RemoveWhite",
...
fabric.Image.filters.Invert = fabric.util.createClass(
  /** @scope fabric.Image.filters.Invert.prototype */ {
    /**
     * @param {String} type
     */
    type: "Invert",
...
fabric.Image.filters.Sepia = fabric.util.createClass(
  /** @scope fabric.Image.filters.Sepia.prototype */ {
    /**
     * @param {String} type
     */
    type: "Sepia",
...
fabric.Image.filters.Sepia2 = fabric.util.createClass(
  /** @scope fabric.Image.filters.Sepia2.prototype */ {
    /**
     * @param {String} type
     */
    type: "Sepia2",
...
fabric.Image.filters.Brightness = fabric.util.createClass(
  /** @scope fabric.Image.filters.Brightness.prototype */ {
    /**
     * @param {String} type
     */
    type: "Brightness",
...
fabric.Image.filters.Noise = fabric.util.createClass(
  /** @scope fabric.Image.filters.Noise.prototype */ {
    /**
     * @param {String} type
     */
    type: "Noise",
...
fabric.Image.filters.GradientTransparency = fabric.util.createClass(
  /** @scope fabric.Image.filters.GradientTransparency.prototype */ {
    /**
     * @param {String} type
     */
...
fabric.Image.filters.Tint = fabric.util.createClass(
  /** @scope fabric.Image.filters.Tint.prototype */ {
    /**
     * @param {String} type
     */
    type: "Tint",
  ...
  fabric.Text = fabric.util.createClass(
    ...
    /** @scope fabric.Text.prototype */ {
      ...
      toSVG: function () {
        ...
        textTopOffset += this._fontAscent
        ...
        return [
          ...
          'transform="translate(',
          toFixed(textLeftOffset, 2),
          " ",
          toFixed(textTopOffset, 2),
          ')">',
          shadowSpans.join(""),
            ...
            textSpans.push(
              ...
              toFixed(
                this.useNative
                  ...
                  : lineTopOffset * lineTopOffsetMultiplier,
                2
              ),
              '" ',
